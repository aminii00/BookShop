...
<c:set  var="totalGoodsNum" value="${cartMap.cart_goods_qty}" />  <!--주문 개수 -->
<c:set  var="totalDeliveryPrice" value="${cartMap.goods_delivery_price}" /> <!-- 총 배송비 --> 
<c:set  var="totalDiscountedPrice" value="${cartMap.goods_sales_price}" /> <!-- 총 할인금액 -->
<head>
